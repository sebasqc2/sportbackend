...
--
-- Host: localhost:3306
-- Generation Time: Jul 29, 2020 at 11:33 AM
...
(2, '2020-07-30', '08:00:00.000', 2, 'hidratacion\npuntualidad', 2, '2020-07-27 13:17:09', '2020-07-27 13:17:09', 1, NULL, 'entrenamiento', 19),
...
(170, 'application', 'escuelas', 'count', 0, '', 2),
(171, 'application', 'escuelas', 'create', 0, '', 1),
(172, 'application', 'escuelas', 'create', 0, '', 2),
(173, 'application', 'escuelas', 'delete', 0, '', 1),
(174, 'application', 'escuelas', 'delete', 0, '', 2),
(175, 'application', 'escuelas', 'find', 0, '', 1),
(176, 'application', 'escuelas', 'find', 0, '', 2),
(177, 'application', 'escuelas', 'findone', 0, '', 1),
(178, 'application', 'escuelas', 'findone', 0, '', 2),
(179, 'application', 'escuelas', 'update', 0, '', 1),
(180, 'application', 'escuelas', 'update', 0, '', 2),
(181, 'application', 'deportes', 'count', 0, '', 1),
(182, 'application', 'deportes', 'count', 0, '', 2),
(183, 'application', 'deportes', 'create', 0, '', 1),
(184, 'application', 'deportes', 'create', 0, '', 2),
(185, 'application', 'deportes', 'delete', 0, '', 1),
(186, 'application', 'deportes', 'delete', 0, '', 2),
(187, 'application', 'deportes', 'find', 0, '', 1),
(188, 'application', 'deportes', 'find', 0, '', 2),
(189, 'application', 'deportes', 'findone', 0, '', 1),
(190, 'application', 'deportes', 'findone', 0, '', 2),
(191, 'application', 'deportes', 'update', 0, '', 1),
(192, 'application', 'deportes', 'update', 0, '', 2),
(193, 'application', 'entrenador', 'count', 0, '', 1),
(194, 'application', 'entrenador', 'count', 0, '', 2),
(195, 'application', 'entrenador', 'create', 0, '', 2),
(196, 'application', 'entrenador', 'create', 0, '', 1),
(197, 'application', 'entrenador', 'delete', 0, '', 1),
(198, 'application', 'entrenador', 'delete', 0, '', 2),
(199, 'application', 'entrenador', 'find', 0, '', 1),
(200, 'application', 'entrenador', 'find', 0, '', 2),
(201, 'application', 'entrenador', 'findone', 0, '', 1),
(202, 'application', 'entrenador', 'findone', 0, '', 2),
(203, 'application', 'entrenador', 'update', 0, '', 1),
(204, 'application', 'entrenador', 'update', 0, '', 2),
(205, 'application', 'acudiente', 'count', 0, '', 1),
(206, 'application', 'acudiente', 'count', 0, '', 2),
(207, 'application', 'acudiente', 'create', 0, '', 1),
(208, 'application', 'acudiente', 'create', 0, '', 2),
(209, 'application', 'acudiente', 'delete', 0, '', 1),
(210, 'application', 'acudiente', 'delete', 0, '', 2),
(211, 'application', 'acudiente', 'find', 0, '', 1),
(212, 'application', 'acudiente', 'find', 0, '', 2),
(213, 'application', 'acudiente', 'findone', 0, '', 1),
(214, 'application', 'acudiente', 'findone', 0, '', 2),
(215, 'application', 'acudiente', 'update', 0, '', 1),
(216, 'application', 'acudiente', 'update', 0, '', 2),
(217, 'application', 'alumnos', 'count', 0, '', 1),
(218, 'application', 'alumnos', 'count', 0, '', 2),
(219, 'application', 'alumnos', 'create', 0, '', 1),
(220, 'application', 'alumnos', 'create', 0, '', 2),
(221, 'application', 'alumnos', 'delete', 0, '', 1),
(222, 'application', 'alumnos', 'delete', 0, '', 2),
(223, 'application', 'alumnos', 'find', 0, '', 2),
(224, 'application', 'alumnos', 'find', 0, '', 1),
(225, 'application', 'alumnos', 'findone', 0, '', 1),
(226, 'application', 'alumnos', 'findone', 0, '', 2),
(227, 'application', 'alumnos', 'update', 0, '', 1),
(228, 'application', 'alumnos', 'update', 0, '', 2),
(229, 'application', 'categorias', 'count', 0, '', 1),
(230, 'application', 'categorias', 'count', 0, '', 2),
(231, 'application', 'categorias', 'create', 0, '', 1),
(232, 'application', 'categorias', 'create', 0, '', 2),
(233, 'application', 'categorias', 'delete', 0, '', 1),
(234, 'application', 'categorias', 'delete', 0, '', 2),
(235, 'application', 'categorias', 'find', 0, '', 1),
(236, 'application', 'categorias', 'find', 0, '', 2),
(237, 'application', 'categorias', 'findone', 0, '', 1),
(238, 'application', 'categorias', 'findone', 0, '', 2),
(239, 'application', 'categorias', 'update', 0, '', 1),
(240, 'application', 'categorias', 'update', 0, '', 2),
(241, 'application', 'valoracion', 'count', 0, '', 1),
(242, 'application', 'valoracion', 'count', 0, '', 2),
(243, 'application', 'valoracion', 'create', 0, '', 1),
(244, 'application', 'valoracion', 'create', 0, '', 2),
(245, 'application', 'valoracion', 'delete', 0, '', 1),
(246, 'application', 'valoracion', 'delete', 0, '', 2),
(247, 'application', 'valoracion', 'find', 0, '', 2),
(248, 'application', 'valoracion', 'find', 0, '', 1),
(249, 'application', 'valoracion', 'findone', 0, '', 1),
(250, 'application', 'valoracion', 'findone', 0, '', 2),
(251, 'application', 'valoracion', 'update', 0, '', 1),
(252, 'application', 'valoracion', 'update', 0, '', 2),
(253, 'application', 'movimientos', 'count', 0, '', 1),
(254, 'application', 'movimientos', 'count', 0, '', 2),
(255, 'application', 'movimientos', 'create', 0, '', 1),
(256, 'application', 'movimientos', 'create', 0, '', 2),
(257, 'application', 'movimientos', 'delete', 0, '', 1),
(258, 'application', 'movimientos', 'delete', 0, '', 2),
(259, 'application', 'movimientos', 'find', 0, '', 1),
(260, 'application', 'movimientos', 'findone', 0, '', 1),
(261, 'application', 'movimientos', 'find', 0, '', 2),
(262, 'application', 'movimientos', 'findone', 0, '', 2),
(263, 'application', 'movimientos', 'update', 0, '', 1),
(264, 'application', 'movimientos', 'update', 0, '', 2),
(265, 'application', 'inventarios', 'count', 0, '', 1),
(266, 'application', 'inventarios', 'count', 0, '', 2),
(267, 'application', 'inventarios', 'create', 0, '', 1),
(268, 'application', 'inventarios', 'create', 0, '', 2),
(269, 'application', 'inventarios', 'delete', 0, '', 1),
(270, 'application', 'inventarios', 'delete', 0, '', 2),
(271, 'application', 'inventarios', 'find', 0, '', 1),
(272, 'application', 'inventarios', 'find', 0, '', 2),
(273, 'application', 'inventarios', 'findone', 0, '', 1),
(274, 'application', 'inventarios', 'findone', 0, '', 2),
(275, 'application', 'inventarios', 'update', 0, '', 1),
(276, 'application', 'inventarios', 'update', 0, '', 2),
(277, 'application', 'lugares', 'count', 0, '', 1),
(278, 'application', 'lugares', 'count', 0, '', 2),
(279, 'application', 'lugares', 'create', 0, '', 1),
(280, 'application', 'lugares', 'create', 0, '', 2),
(281, 'application', 'lugares', 'delete', 0, '', 1),
(282, 'application', 'lugares', 'delete', 0, '', 2),
(283, 'application', 'lugares', 'find', 0, '', 1),
(284, 'application', 'lugares', 'find', 0, '', 2),
(285, 'application', 'lugares', 'findone', 0, '', 1),
(286, 'application', 'lugares', 'findone', 0, '', 2),
(287, 'application', 'lugares', 'update', 0, '', 1),
(288, 'application', 'lugares', 'update', 0, '', 2),
(289, 'application', 'actividades', 'count', 0, '', 1),
(290, 'application', 'actividades', 'count', 0, '', 2),
(291, 'application', 'actividades', 'create', 0, '', 1),
(292, 'application', 'actividades', 'create', 0, '', 2),
(293, 'application', 'actividades', 'delete', 0, '', 1),
(294, 'application', 'actividades', 'delete', 0, '', 2),
(295, 'application', 'actividades', 'find', 0, '', 1),
(296, 'application', 'actividades', 'find', 0, '', 2),
(297, 'application', 'actividades', 'findone', 0, '', 1),
(298, 'application', 'actividades', 'findone', 0, '', 2),
(299, 'application', 'actividades', 'update', 0, '', 1),
(300, 'application', 'actividades', 'update', 0, '', 2),
...
(342, 'application', 'alumnos', 'create', 0, '', 3),
(343, 'application', 'alumnos', 'update', 0, '', 3),
(344, 'application', 'alumnos', 'delete', 0, '', 3),
...
(610, 'application', 'mensualidades', 'count', 0, '', 2),
(611, 'application', 'mensualidades', 'count', 0, '', 3),
(612, 'application', 'mensualidades', 'count', 0, '', 7),
(613, 'application', 'mensualidades', 'create', 0, '', 2),
...
(630, 'application', 'mensualidades', 'update', 0, '', 2),
...
(2, 'pepegomez', 'adminstrador@strapi.io', 'local', '$2a$10$aFTsul/XrRUoP1VfP.V2lOhT8Ah7Q3KkspCvb8ZXpFxACZDL9Z2cm', NULL, 1, 0, 7, '2020-07-26 20:19:53', '2020-07-26 20:19:53');
